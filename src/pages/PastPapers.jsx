...
import { getPastPapers } from '@/lib/pastPaperBank';
...
const categoryIcons = {
  ...
  'Subject': <BookOpen className="w-8 h-8 text-gray-400" />,
};
...
const sectionColors = {
  ...
  'Subject': 'from-gray-500/20 to-gray-500/5 border-gray-500/30 text-gray-500 hover:border-gray-500/50',
};
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="p-6 sm:p-10 bg-card rounded-3xl border-2 border-border shadow-md relative overflow-hidden">
            ...
            <h3 className="font-display text-2xl font-bold leading-relaxed mb-10 text-foreground">{q.question_text}</h3>
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            <h1 className="font-display text-4xl font-black text-foreground">Past Papers</h1>
          ...
          <p className="text-muted-foreground font-medium text-lg">Master the NAT by practicing with actual previous exam questions.</p>
        </div>
        <button onClick={() => navigate('/')} className="py-2.5 px-5 bg-card border-2 border-border text-foreground hover:bg-secondary rounded-xl font-bold transition-colors shadow-sm self-start sm:self-center flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-card rounded-3xl p-6 border-2 border-border shadow-sm flex items-center gap-5 hover:border-amber-500/40 transition-colors">
          ...
          <div>
            ...
            <p className="text-xs uppercase font-bold text-muted-foreground tracking-widest">Latest Update</p>
          </div>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="p-16 text-center border-4 border-dashed border-border bg-card/50 rounded-[40px]">
          ...
          <p className="text-base text-muted-foreground max-w-sm mx-auto mb-8 font-medium">No past paper questions have been added to the database yet.</p>
          {user?.role === 'admin' && (
            <button className="py-3 px-6 bg-secondary text-foreground font-bold rounded-xl border border-border shadow-sm hover:bg-secondary/80" onClick={() => navigate('/admin/importer')}>
              Open Importer
            </button>
          )}
        </div>
            ...
            >
              ...
              >
                ...
                <div className="space-y-2 relative z-10">
                  ...
                  <p className="text-sm font-medium text-muted-foreground">Previous exam bank</p>
                </div>
      ...
      <div className="bg-card p-8 sm:p-10 rounded-[40px] border-2 border-primary/20 flex flex-col sm:flex-row items-center gap-8 justify-between shadow-lg shadow-primary/5 relative overflow-hidden">
        ...
        <div className="space-y-3 text-center sm:text-left relative z-10">
          ...
          <p className="text-base text-muted-foreground font-medium max-w-md">We are constantly updating our database with new past papers. Let us know what you need.</p>
        </div>
